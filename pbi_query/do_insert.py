...
def clean_tmp_data():
    remove_files_in_dir('../playground_adds')
    remove_files_in_dir('../playground_parsed_adds')
    #remove_files_in_dir('../playground_ai')
    remove_files_in_dir('../playground_ai_parsed')
    remove_files_in_dir('../playground_parsed')
    remove_files_in_dir('../play_ground_export_query')
...
if __name__ == "__main__":
    ...
    conv.processJsonDir()
    data = open('../moi_doc_json/insert.sparql', encoding="UTF-8").read()
...
#     crepl=replace_cols_tabs('',stmt.stmt_tabs_expressions_to_replace,stmt.stmt_tables_cols, stmt.stmt_cols_expressions_to_replace
# , '../playground_parsed_adds/', stmt_all_dashes)
#     crepl.do_dashes()
